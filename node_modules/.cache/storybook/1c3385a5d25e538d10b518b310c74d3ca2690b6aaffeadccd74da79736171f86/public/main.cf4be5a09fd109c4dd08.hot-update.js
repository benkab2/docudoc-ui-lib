...
/* harmony import */ var _src_utils_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/utils/helpers */ "./src/utils/helpers.ts");
...
var preview = {
  ...
  decorators: [function (Story) {
    ...
    if (storybookParent) {
      ...
      var backgroundColor = (0,_src_utils_helpers__WEBPACK_IMPORTED_MODULE_3__.rgbToHex)(computedStyles.backgroundColor);
      var theme = THEME_MODE_MAP[backgroundColor === null || backgroundColor === void 0 ? void 0 : backgroundColor.toUpperCase()];

      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2690037165_51_8_51_55_4", 'backgroundColor', backgroundColor)));
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2690037165_52_8_52_35_4", 'theme', theme)));
    }
    // useEffect(() => {
    //   // Find the iframe element containing the story
    //   const iframe = document.querySelector('.sb-show-main iframe');
    //   if (iframe) {
    //     // Extract the active background color class from the iframe
    //     const backgroundColorClass = [...iframe.classList].find((className) =>
    //       className.startsWith('sb-background-'),
    //     );
    //     // Extract the background color from the class name
    //     const backgroundColor = backgroundColorClass
    //       ? backgroundColorClass.split('-').pop()
    //       : '';
...
//# sourceMappingURL=main.cf4be5a09fd109c4dd08.hot-update.js.map