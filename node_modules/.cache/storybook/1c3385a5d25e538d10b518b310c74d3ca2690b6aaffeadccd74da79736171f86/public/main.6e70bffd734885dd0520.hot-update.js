...
var preview = {
  ...
  decorators: [function (Story) {
    var _console;
    var iframe = document.querySelector('.sb-show-main iframe');

    /* eslint-disable */
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1070843942_33_6_33_35_4", 'iframe', iframe)));
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
      ...
      if (iframe) {
        ...
        var backgroundColorClass = _toConsumableArray(iframe.classList).find(function (className) {
          return className.startsWith('sb-background-');
        });
        // Extract the background color from the class name
        var backgroundColor = backgroundColorClass ? backgroundColorClass.split('-').pop() : '';

        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1070843942_48_10_48_57_4", 'backgroundColor', backgroundColor)));
      }
    }, []);
...
//# sourceMappingURL=main.6e70bffd734885dd0520.hot-update.js.map