...
`),n+=t[s].slice(r).replace(/\\"""/g,'"""');return n}function te(){for(var e=0|we.charCodeAt(J++);e===9||e===10||e===13||e===32||e===35||e===44||e===65279;e=0|we.charCodeAt(J++))if(e===35)for(;(e=we.charCodeAt(J++))!==10&&e!==13;);J--}var _s=/[_A-Za-z]\w*/y;function Mt(){var e;if(e=Qe(_s))return{kind:"Name",value:e}}var Gu=/(?:null|true|false)/y,Ts=/\$[_A-Za-z]\w*/y,qu=/-?\d+/y,Yu=/(?:\.\d+)?[eE][+-]?\d+|\.\d+/y,Qu=/\\/g,Ku=/"""(?:"""|(?:[\s\S]*?[^\\])""")/y,Ju=/"(?:"|[^\r\n]*?[^\\]")/y;function sr(e){var t,n;if(n=Qe(Gu))t=n==="null"?{kind:"NullValue"}:{kind:"BooleanValue",value:n==="true"};else if(!e&&(n=Qe(Ts)))t={kind:"Variable",name:{kind:"Name",value:n.slice(1)}};else if(n=Qe(qu)){var r=n;(n=Qe(Yu))?t={kind:"FloatValue",value:r+n}:t={kind:"IntValue",value:r}}else if(n=Qe(_s))t={kind:"EnumValue",value:n};else if(n=Qe(Ku))t={kind:"StringValue",value:Wu(n.slice(3,-3)),block:!0};else if(n=Qe(Ju))t={kind:"StringValue",value:Qu.test(n)?JSON.parse(n):n.slice(1,-1),block:!1};else if(t=function(i){var o;if(we.charCodeAt(J)===91){J++,te();for(var l=[];o=sr(i);)l.push(o);if(we.charCodeAt(J++)!==93)throw Fe("ListValue");return te(),{kind:"ListValue",values:l}}}(e)||function(i){if(we.charCodeAt(J)===123){J++,te();for(var o=[],l;l=Mt();){if(te(),we.charCodeAt(J++)!==58)throw Fe("ObjectField");te();var s=sr(i);if(!s)throw Fe("ObjectField");o.push({kind:"ObjectField",name:l,value:s})}if(we.charCodeAt(J++)!==125)throw Fe("ObjectValue");return te(),{kind:"ObjectValue",fields:o}}}(e))return t;return te(),t}function Zs(e){var t=[];if(te(),we.charCodeAt(J)===40){J++,te();for(var n;n=Mt();){if(te(),we.charCodeAt(J++)!==58)throw Fe("Argument");te();var r=sr(e);if(!r)throw Fe("Argument");t.push({kind:"Argument",name:n,value:r})}if(!t.length||we.charCodeAt(J++)!==41)throw Fe("Argument");te()}return t}function Sn(e){var t=[];for(te();we.charCodeAt(J)===64;){J++;var n=Mt();if(!n)throw Fe("Directive");te(),t.push({kind:"Directive",name:n,arguments:Zs(e)})}return t}function Xu(){var e=Mt();if(e){te();var t;if(we.charCodeAt(J)===58){if(J++,te(),t=e,!(e=Mt()))throw Fe("Field");te()}return{kind:"Field",alias:t,name:e,arguments:Zs(!1),directives:Sn(!1),selectionSet:Dr()}}}function Is(){var e;if(te(),we.charCodeAt(J)===91){J++,te();var t=Is();if(!t||we.charCodeAt(J++)!==93)throw Fe("ListType");e={kind:"ListType",type:t}}else if(e=Mt())e={kind:"NamedType",name:e};else throw Fe("NamedType");return te(),we.charCodeAt(J)===33?(J++,te(),{kind:"NonNullType",type:e}):e}var e2=/on/y;function Rs(){if(Qe(e2)){te();var e=Mt();if(!e)throw Fe("NamedType");return te(),{kind:"NamedType",name:e}}}var t2=/\.\.\./y;function n2(){if(Qe(t2)){te();var e=J,t;if((t=Mt())&&t.value!=="on")return{kind:"FragmentSpread",name:t,directives:Sn(!1)};J=e;var n=Rs(),r=Sn(!1),i=Dr();if(!i)throw Fe("InlineFragment");return{kind:"InlineFragment",typeCondition:n,directives:r,selectionSet:i}}}function Dr(){var e;if(te(),we.charCodeAt(J)===123){J++,te();for(var t=[];e=n2()||Xu();)t.push(e);if(!t.length||we.charCodeAt(J++)!==125)throw Fe("SelectionSet");return te(),{kind:"SelectionSet",selections:t}}}var a2=/fragment/y;function r2(){if(Qe(a2)){te();var e=Mt();if(!e)throw Fe("FragmentDefinition");te();var t=Rs();if(!t)throw Fe("FragmentDefinition");var n=Sn(!1),r=Dr();if(!r)throw Fe("FragmentDefinition");return{kind:"FragmentDefinition",name:e,typeCondition:t,directives:n,selectionSet:r}}}var i2=/(?:query|mutation|subscription)/y;function o2(){var e,t,n=[],r=[];(e=Qe(i2))&&(te(),t=Mt(),n=function(){var o,l=[];if(te(),we.charCodeAt(J)===40){for(J++,te();o=Qe(Ts);){if(te(),we.charCodeAt(J++)!==58)throw Fe("VariableDefinition");var s=Is(),c=void 0;if(we.charCodeAt(J)===61&&(J++,te(),!(c=sr(!0))))throw Fe("VariableDefinition");te(),l.push({kind:"VariableDefinition",variable:{kind:"Variable",name:{kind:"Name",value:o.slice(1)}},type:s,defaultValue:c,directives:Sn(!0)})}if(we.charCodeAt(J++)!==41)throw Fe("VariableDefinition");te()}return l}(),r=Sn(!1));var i=Dr();if(i)return{kind:"OperationDefinition",operation:e||"query",name:t,variableDefinitions:n,directives:r,selectionSet:i}}function l2(e,t){return we=typeof e.body=="string"?e.body:e,J=0,function(){var n;te();for(var r=[];n=r2()||o2();)r.push(n);return{kind:"Document",definitions:r}}()}function s2(e){return JSON.stringify(e)}function c2(e){return`"""
`+e.replace(/"""/g,'\\"""')+`
...
`)),l+=m+r[c+1]}),l}var w4=w.div(({theme:e})=>({"&& > *":{margin:0},"&& pre":{color:e.base==="light"?e.color.darker:e.color.lighter,background:e.base==="light"?e.color.lightest:e.color.darkest,fontSize:"12px",lineHeight:"16px",textAlign:"left",padding:"15px !important"}})),C4="https://www.chromatic.com/docs/visual-tests-addon/#configure";function S4({projectId:e,configFile:t}){return ot("LinkProject","LinkingProjectFailed"),a.createElement(Me,null,a.createElement(ke,null,a.createElement(me,null,a.createElement("div",null,a.createElement(fe,null,"Add the project ID to your Chromatic config"),a.createElement(Q,{center:!0,muted:!0},"The ",a.createElement(Ve,null,"projectId")," will be used to sync tests with Chromatic. Please commit this change to continue using the addon. The file should be saved at"," ",a.createElement(Ve,null,t),".")),a.createElement(w4,null,a.createElement(Ve,null,k4`
              ...
              `)),a.createElement(Ge,{secondary:!0,withArrow:!0,target:"_blank",href:C4},"What's this for?"))))}var x4=ft(`
  query SelectProjectsQuery {
    viewer {
      accounts {
        id
