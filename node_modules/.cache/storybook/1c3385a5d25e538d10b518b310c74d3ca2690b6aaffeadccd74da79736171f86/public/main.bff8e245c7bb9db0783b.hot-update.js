...
var preview = {
  ...
  decorators: [function (Story) {
    ...
    if (storybookParent) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2773667067_39_8_39_57_4", 'Background Color:', backgroundColor)));
    }
    // useEffect(() => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   beautifyNumber: () => (/* binding */ beautifyNumber),
...
var beautifyNumber = function beautifyNumber(number) {
  // Convert number to string and format using toLocaleString()
  return Number(number).toLocaleString('en-US');
};
var rgbToHex = function rgbToHex(rgb) {
  var regex = /rgb\((\d+), (\d+), (\d+)\)/;
  var _rgb$match = rgb.match(regex),
    _rgb$match2 = _slicedToArray(_rgb$match, 4),
    r = _rgb$match2[1],
    g = _rgb$match2[2],
    b = _rgb$match2[3];
  var hexR = Number(r).toString(16).padStart(2, '0');
  var hexG = Number(g).toString(16).padStart(2, '0');
  var hexB = Number(b).toString(16).padStart(2, '0');
...
//# sourceMappingURL=main.bff8e245c7bb9db0783b.hot-update.js.map